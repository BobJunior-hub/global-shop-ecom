        ...
        <div className="flex flex-col gap-5 pt-2">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            {inCart ? (
              <Link
                href="/cart"
                className="inline-flex items-center justify-center gap-1 flex-1 px-3 py-1.5 sm:px-8 sm:py-3 rounded-full text-xs sm:text-base font-semibold transition-colors bg-black text-white hover:bg-zinc-800 whitespace-nowrap"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-1 flex-1 px-3 py-1.5 sm:px-8 sm:py-3 rounded-full text-xs sm:text-base font-semibold transition-colors disabled:opacity-40 disabled:cursor-not-allowed bg-black text-white hover:bg-zinc-800 whitespace-nowrap"
              >
                {selectedVariant && isAdding(selectedVariant.id) ? (
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1 flex-1 px-3 py-1.5 sm:px-5 sm:py-3 rounded-full text-xs sm:text-sm font-semibold transition-colors bg-zinc-900 hover:bg-zinc-700 text-white whitespace-nowrap"
            >
