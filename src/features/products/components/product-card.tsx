  ...
  return (
    <div className="group relative flex flex-col rounded-xl border border-zinc-200 bg-white overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="px-3 pb-5">
        {qty > 0 ? (
          <div className={`inline-flex items-center w-full justify-between rounded-xl ${theme.primary} text-white text-sm font-semibold overflow-hidden`}>
            <button
          ...
          <button
            ...
            className={`w-full flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl ${theme.primary} ${theme.primaryHover} text-white text-sm font-semibold transition-colors disabled:opacity-40 disabled:cursor-not-allowed`}
          >
            {adding ? (
