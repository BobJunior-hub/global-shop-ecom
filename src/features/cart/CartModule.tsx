    ...
    return (
      <div className="flex flex-col flex-1 items-center justify-center py-20">
        <EmptyState
          ...
          description="Boshlash uchun mahsulotlar qo'shing."
          action={
            <Link href="/products">
          ...
          {groups.map((group) => (
            <div key={group.store.id} className="rounded-xl border border-zinc-200 bg-white px-6">
              ...
              <div className="flex items-center gap-2 py-3 border-b border-zinc-100">
                <svg className="w-4 h-4 text-green-600 shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
