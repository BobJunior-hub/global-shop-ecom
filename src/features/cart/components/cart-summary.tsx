      ...
      {showChoice ? (
        <div className="flex flex-col gap-3">
          ...
          <Link
            ...
            className="flex items-center gap-3 w-full px-4 py-3 rounded-xl bg-zinc-900 text-white text-sm font-semibold hover:bg-zinc-800 transition-colors"
          >
        ...
        <Button type="button" className="w-full" size="lg" onClick={handleCheckout} loading={!hydrated}>
          To&apos;lovga o&apos;tish
        </Button>
      )}
