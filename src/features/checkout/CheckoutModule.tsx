    ...
    return (
      <div className="flex flex-col flex-1 items-center justify-center py-12 px-4">
        <div className="w-full max-w-md bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden">
          <div className="bg-black px-6 py-5 flex flex-col items-center gap-2 text-center">
            ...
            <div>
              <p className="text-[10px] font-bold italic tracking-widest text-white/50 uppercase">Al-Baraka</p>
          ...
          <div className="px-6 py-5 flex flex-col gap-4">
                ...
                return (
                  <div key={item.id} className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex flex-col items-end shrink-0 gap-0.5">
                      ...
                      <span className="text-sm font-semibold text-zinc-900">{(unitPrice * item.qty).toLocaleString()} UZS</span>
                    </div>
                  </div>
                );
              })}
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-base font-bold text-zinc-900">{receiptTotal.toLocaleString()} UZS</span>
            </div>
          </div>
          ...
          <div className="px-6 pb-6">
            {!isLastGroup ? (
              <button
                ...
                className="w-full py-3 rounded-xl bg-black text-white text-sm font-semibold hover:bg-zinc-800 transition-colors"
              >
          ...
          <div className="rounded-xl border border-zinc-200 bg-white p-4">
            ...
            <div className="flex flex-wrap gap-2">
              {currentCards.map((card) => (
                <div key={card.id} className="flex items-center gap-2 px-3 py-2 rounded-lg border border-zinc-200 bg-zinc-50">
                  ...
                  <span className="text-sm font-mono font-semibold text-zinc-800 tracking-widest">
