  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1">
        ...
        >
          <span className={`shrink-0 px-3 py-1 rounded-md ${theme.primary} text-white text-xs font-semibold`}>
            Fayl tanlash
          </span>
      ...
      <button
        type="submit"
        disabled={loading}
        className={`w-full mt-2 py-3 rounded-xl ${theme.primary} ${theme.primaryHover} text-white text-sm font-semibold transition-colors disabled:opacity-50 flex items-center justify-center gap-2`}
      >
